...
static int image_option_move_ids[] = {
	...
	IDS_CLUSTER_SIZE_TXT,
        ...
        IDC_NB_PASSES,
        IDC_EXTENDED_LABEL,
        IDC_ADVANCED_EXTRAS_TOOLBAR,
        IDC_DETECT_FAKE_DRIVES,
        IDC_ENABLE_VHD,
        IDC_ENABLE_VMDK,
        IDC_ALLOW_DUAL_EFI_BIOS,
        IDS_STATUS_TXT,
        IDC_PROGRESS,
        IDC_ABOUT,
        IDC_LOG,
...
static int advanced_extras_move_ids[] = {
        IDS_STATUS_TXT,
        IDC_PROGRESS,
        IDC_ABOUT,
        IDC_LOG,
...
static int advanced_extras_toggle_ids[] = {
        IDC_DETECT_FAKE_DRIVES,
        IDC_ENABLE_VHD,
        IDC_ENABLE_VMDK,
        IDC_ALLOW_DUAL_EFI_BIOS,
...
static int adjust_dpi_ids[][5] = {
	...
	{ IDS_FILE_SYSTEM_TXT, IDC_FILE_SYSTEM, IDS_CLUSTER_SIZE_TXT, IDC_CLUSTER_SIZE, 0 },
        ...
        { IDC_ADVANCED_EXTRAS_TOOLBAR, 0, 0, 0, 0 },
        { IDC_DETECT_FAKE_DRIVES, 0, 0, 0, 0 },
        { IDC_ENABLE_VHD, 0, 0, 0, 0 },
        { IDC_ENABLE_VMDK, 0, 0, 0, 0 },
        { IDC_ALLOW_DUAL_EFI_BIOS, 0, 0, 0, 0 },
