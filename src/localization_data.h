...
const loc_control_id control_id[] = {
	...
	LOC_CTRL(IDC_LIST_ITEM12),
        ...
        LOC_CTRL(IDC_ADVANCED_EXTRAS_OPTIONS),
        LOC_CTRL(IDC_DETECT_FAKE_DRIVES),
        LOC_CTRL(IDC_ENABLE_VHD),
        LOC_CTRL(IDC_ENABLE_VMDK),
        LOC_CTRL(IDC_ALLOW_DUAL_EFI_BIOS),
        LOC_CTRL(IDC_ADVANCED_EXTRAS_TOOLBAR),
